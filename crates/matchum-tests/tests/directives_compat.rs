...
mod extended_directives {
    ...
    fn ignore_reg_exp_hyphenated_not_valid() {
        ...
        assert!(
            result.is_none(),
            "hyphenated ignore-reg-exp should not be valid"
        );
    }
...
// Note: LocalWords is NOT recognized by cspell. These are skipped
// for cspell compatibility. parse_directive returns None for LocalWords.
