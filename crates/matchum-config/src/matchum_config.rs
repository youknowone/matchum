...
pub struct MatchumConfig {
    ...
    pub dictionary_definitions: Vec<MatchumDictDef>,
    ...
    pub overrides: Vec<MatchumOverride>,

    /// Per-language-type dictionary activation.
    #[serde(rename = "language_setting")]
    pub language_settings: Vec<MatchumLanguageSetting>,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct MatchumDictDef {
    pub name: String,
...
#[derive(Debug, Clone, Deserialize, Serialize, Default)]
#[serde(default)]
pub struct MatchumLanguageSetting {
...
mod tests {
    ...
    fn parse_minimal_toml() {
        ...
        let config: MatchumConfig = toml::from_str(input).unwrap();
...
"#;
    ...
    fn roundtrip_serialize() {
        ...
        let parsed: MatchumConfig = toml::from_str(&toml_str).unwrap();
